	...
	<div class="wrapper wrapper-content animated fadeInRight">	
		<div class="ibox">
			...
			<div class="ibox-content">
				<form id="inputForm" action="${base}/admin/admin/update" method="post" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" id=""  name="name" class="text" maxlength="100" value="${admin.name}" />
						</div>
					
						
						<label class="col-sm-1 control-label">用户名:</label>
						<div class="col-sm-5">
							<input type="text" id="" name="username" class="text" maxlength="100" value="${admin.username}" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" id=""  name="password" class="text" maxlength="100" value="${admin.password}" />
						</div>
					
						
						<label class="col-sm-1 control-label">时间:</label>
						<div class="col-sm-5">
							<input type="text" id="date" name="date" class="text" maxlength="100" value="${(admin.date?string('yyyy-MM-dd hh:mm:ss'))!}" />
						</div>
					</div>
					<div class="hr-line-dashed"></div>
