	...
	<div class="ibox">
		...
		<div class="ibox-title">
			<ol class="breadcrumb">
                ...
                <li class="active">管理员列表<span>(共<span id="pageTotal">${page.total}</span>条记录)</span></li>
            </ol>
		</div>
				...
				<div class="table-responsive">
					<table id="listTable" class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td>${(admin.date?string("yyyy-MM-dd hh:mm:ss"))!}</td>
   							
				 			<td>
					 			<a href="${base}/admin/admin/view?id=${admin.id}" class="btn btn-sm btn-white btn-bitbucket">
									<i class="fa fa-eye"></i> 查看
								</a>
								<a href="${base}/admin/admin/edit?id=${admin.id}" class="btn btn-sm btn-white btn-bitbucket">
